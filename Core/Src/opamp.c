...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PA3     ------> OPAMP1_VINP
    */
    GPIO_InitStruct.Pin = FOLLOWER_OUT_Pin|FOLLOWER_IN_Pin;
  ...
  /* USER CODE END OPAMP3_MspInit 0 */
    ...
    PB2     ------> OPAMP3_VINM
    */
    GPIO_InitStruct.Pin = OP_VINP_Pin|OP_VOUT_Pin|OP_VINM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA3     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(GPIOA, FOLLOWER_OUT_Pin|FOLLOWER_IN_Pin);
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB2     ------> OPAMP3_VINM
    */
    HAL_GPIO_DeInit(GPIOB, OP_VINP_Pin|OP_VOUT_Pin|OP_VINM_Pin);
